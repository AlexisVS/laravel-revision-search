...
@section('content')
  ...
  <form action="/search" method="GET" class="w-max">
    <input type="text" name="search" id="">
    <input class="bg-white" type="submit" value="Rechercher">
  </form>

  <div class="w-full flex flex-col flex-wrap space-y-32 justify-center">
